...
完整示例请参考：`.omni-infra/templates/interface-config-simple-example.md`
...
# 系统安装时会自动生成模板文件
# 如果不存在，可以手动创建：
cp .omni-infra/templates/interface-config-simple.md .cache/user_input/interface-config.md
```
