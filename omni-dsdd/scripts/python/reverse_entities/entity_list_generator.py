...
参数说明:
    ...
    --entity-dir: 实体文档目录（可选，默认 {REPO_ROOT}/omni-doc/specs/entities）
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="实体文档目录（可选，默认 {REPO_ROOT}/omni-doc/specs/entities）",
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    try:
        ...
        if args.entity_dir:
            ...
            # 默认：最终实体文档目录
            entity_dir = repo_root / "omni-doc" / "specs" / "entities"
