...
main() {
    ...
    if [[ -f "$REPO_ROOT/.omni-infra/scripts/python/update_batch_details_file_status.py" ]]; then
        status_updater="$REPO_ROOT/.omni-infra/scripts/python/update_batch_details_file_status.py"
