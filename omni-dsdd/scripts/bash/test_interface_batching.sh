...
EOF
    ...
    # 创建模板文件
    cat > "$test_dir/.omni-infra/templates/reverse-interface-detail-template.md" << 'EOF'
# 接口文档：{{interface_name}}
...
EOF
    ...
    cat > "$test_dir/.omni-infra/templates/reverse-interface-inventory-template.md" << 'EOF'
# 接口清单
