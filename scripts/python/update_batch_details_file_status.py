...
- 输入批次文件：{REPO_ROOT}/.cache/reverse/interfaces/batch-details-{batch_number}.json
- 临时产出文件：{REPO_ROOT}/.cache/reverse/interfaces/temp/interface-{batch_number}-{file_index}.json
