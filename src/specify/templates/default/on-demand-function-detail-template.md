...
- **功能现状分析**: `{FEATURE_DIR}/baseline/on-demand/_cache/stage3/{function_key}/current-state.json`
- **业务流程**: `{FEATURE_DIR}/baseline/on-demand/_cache/stage3/{function_key}/business-flow.md`
- **入口分析**: `{FEATURE_DIR}/baseline/on-demand/_cache/stage3/{function_key}/entrypoints.json`
- **波及点候选**: `{FEATURE_DIR}/baseline/on-demand/_cache/stage3/{function_key}/impact-points.json`
- **证据汇总**: `{FEATURE_DIR}/baseline/on-demand/_cache/stage3/{function_key}/evidence.json`
