...
# 定义ccr集成命令集
COMMANDS=(
    # "ccr code --dangerously-skip-permissions -p /omni.constitution"
    "ccr code --dangerously-skip-permissions -p \"/omni.specify @requirement.md\""
    "ccr code --dangerously-skip-permissions -p \"/omni.clarify 不要询问，使用默认建议\""
    "ccr code --dangerously-skip-permissions -p /omni.design"
    "ccr code --dangerously-skip-permissions -p /omni.tasks"
    "ccr code --dangerously-skip-permissions -p \"/omni.analyze 不要询问，按照建议修复问题\""
    "ccr code --dangerously-skip-permissions -p /omni.implement"
    "ccr code --dangerously-skip-permissions -p /omni.checklist"
)

# 定义每个命令对应的输出文件 (使用关联数组,键为命令,值为输出文件配置)
# 使用 | 分隔多个文件,空字符串表示无需检查
declare -A OUTPUT_FILES
# OUTPUT_FILES["ccr code --dangerously-skip-permissions -p /omni.constitution"]=""
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p \"/omni.specify @requirement.md\""]="changes/001-*/spec.md"
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p \"/omni.clarify 不要询问，使用默认建议\""]=""
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p /omni.design"]="changes/001-*/design.md|changes/001-*/data-model.md|changes/001-*/quickstart.md|changes/001-*/research.md"
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p /omni.tasks"]="changes/001-*/tasks.md"
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p \"/omni.analyze 不要询问，按照建议修复问题\""]=""
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p /omni.implement"]=""
OUTPUT_FILES["ccr code --dangerously-skip-permissions -p /omni.checklist"]=""
