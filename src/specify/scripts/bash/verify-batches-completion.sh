...
determine_cache_info() {
    ...
    case "$stage_type" in
        "scenarios")
            cache_dir="$REPO_ROOT/.cache/omni-reverse/scenarios"
        ...
        "interfaces")
            ...
            ;;
        "call-chain")
            cache_dir="$REPO_ROOT/.cache/omni-reverse/functions/call-chain-analysis"
            status_file="call_chain_analysis-batch-status.json"
            output_pattern="call-chains-batch-{batch_number}.json"
            ;;
        "function-identification")
            cache_dir="$REPO_ROOT/.cache/omni-reverse/functions/function-identification"
            status_file="function_identification-batch-status.json"
            output_pattern="functions-batch-{batch_number}.json"
            ;;
        "test-case-analysis")
            cache_dir="$REPO_ROOT/.cache/omni-reverse/functions/test-case-analysis"
