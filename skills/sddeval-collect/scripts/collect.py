...
# API 配置
API_URL = "https://maas-apigateway.dt.zte.com.cn/model/qwen3-coder-480b-a35b-instruct-fp8/v1/chat/completions"
API_KEY = "j4jrhmbjepo1t9rxjk77fmv93w547rq5"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default=None,
        help="输出文件路径，默认: changes/<branch>/evalset/configiEval.generated.json",
    )
    ...
    if args.output:
        ...
        output = output_dir / "configiEval.generated.json"
