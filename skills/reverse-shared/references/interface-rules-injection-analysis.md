...
**模板文件**：`{REPO_ROOT}/.infra/templates/interface-type-selection-template.md`
...
**模板文件**：`{REPO_ROOT}/.infra/templates/constraint-configuration-template.md`
...
**模板文件**：`{REPO_ROOT}/.infra/templates/final-confirmation-template.md`
...
**系统默认模板**：`{REPO_ROOT}/.infra/templates/interface-identification-rules-default.yaml`（备用）
